...
### Provide feedback 
Once you are done, please provide feedback on the cheatsheets you have tried out. You can do this by submitting a comment on the form provided to you on the cheatsheets page. The form will ask you to rate the cheatsheet, and should take no more than 2 minutes to complete, so please help us out!
...
This exercise is designed to get you thinking about how to model data. You can consider how you would "model" the data and draw the plots on whiteboards or paper. Work in groups to discuss different modeling approaches. 
...
Notice that in the example above, you have not performed any data analysis. You are simply considering how to model the data, which is an important step in study design. This helps you determine the type of data you need to collect and how to analyse it.
...
These plots are often associated with specific empirical models, which we will cover in the upcoming weeks. Your demonstrators will assist you with this exercise and review your ideas and plots, but you should also try to work on them independently, and seek help from your peers and online resources if necessary.
