...
## SPSS
::: callout-note
Development for SPSS is paused for now.
:::

- [boxplots](https://envx-resources.github.io/cheatsheet-spss-boxplot/) | [scatterplots](https://usyd-soles-edu.github.io/cheatsheet-spss-scatterplot/) | [using the chart builder](https://usyd-soles-edu.github.io/cheatsheet-spss-chart-builder/) 
...
- [Principal Component Analysis (PCA)](https://usyd-soles-edu.github.io/cheatsheet-jamovi-pca/)

## General

- [Publication-ready ANOVA tables](assets/cheatsheet_manual_anova_table.pdf)
- [Publication-ready regression tables](assets/cheatsheet_manual_lm_table.pdf)