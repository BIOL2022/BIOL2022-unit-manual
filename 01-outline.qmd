...
- A penalty of 5% per day will be applied for late submissions of reports and data. If you think you will be late, please contact us as soon 

## Generative AI

There's no escaping generative AI (GenAI) -- so let's use it responsibly. 

In most cases, we're happy for you to use it **as long as you're transparent about using it**, and that you are not using it to write your reports *directly*. Remember that you are here to learn -- GenAI is in fact an excellent tool to help you understand the concepts better, but using it to do your work defeats that  purpose. 
