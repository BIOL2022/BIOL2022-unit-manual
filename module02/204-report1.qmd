...
---
The project written report is the individual component of this assessment It is submitted via the Canvas assignment Prac part 2: individual practical written report. 
The other component of this assignment is the data file, which should be submitted by one group member via the Canvas assignment Prac part 2: group data.
...
Plagiarism
Do not plagiarise or you will face penalties.
•	Check the website http://sydney.edu.au/students/academic-integrity.html for access to: 
	the policies and codes covering academic honesty and conduct at the University
	a link to the AHEM (Academic Honesty Education Module); complete the module if you haven’t already done so. 
You cannot submit your report if you have not completed this module
•	If you are still unsure about how to avoid plagiarism, check with Clare McArthur well before submitting your report. 
•	Your report will be checked for plagiarism using Turnitin or other such software.
...
START EARLY, START EARLY, START EARLY: you can start to draft your introduction as early as Week 6, once you have read the literature on the topic and have a feel for what your experiment will cover. Don’t try to make it perfect – just get some words down. You can also start to draft your Materials and Methods section once you have started your experiment and before Week 8. You should be able to draft your result section after Week 8 and then finalise your whole report, including your discussion, in Week 9 and before submitting in Week 10.
